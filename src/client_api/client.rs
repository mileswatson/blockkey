...
#[allow(dead_code)]
impl Client {
    pub async fn new(private: PrivateKey) -> Self {
        Client {
            private,
    ...
    pub async fn send_transaction(&mut self, transaction: Transaction) {
    ...
    pub async fn make_currency_transfer(&mut self, amount: u64, recipient: UserId) {
        let transfer = self
            .private
    ...
    pub async fn make_license_purchase(&mut self, seller: UserId, license: LicenseId, price: u64) {
    ...
    pub async fn make_license_transfer(&mut self, license: LicenseId, recipient: UserId) {
        let transfer = self
            .private
